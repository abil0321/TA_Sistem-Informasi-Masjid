    ...
    <div class="row gx-0 align-items-center">
        <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
            <div class="d-flex flex-wrap">
                <a href="https://maps.app.goo.gl/aBJFJHBqgRwfZPz68" target="_blank" class="text-muted small me-4"><i
                        class="fas fa-map-marker-alt text-primary me-2"></i>Jl. Bukit Cengkeh Bar., Tugu, Kec. Cimanggis, Kota Depok, Jawa Barat 16451</a>
